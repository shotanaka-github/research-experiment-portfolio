...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--color-session", type=int, default=1)
    parser.add_argument("--name-list-file", type=Path, default=None)
    parser.add_argument("--names-dir", type=Path, default=None)
